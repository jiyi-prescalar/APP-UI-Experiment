...
import sty from "./PlasmicPageLayout.module.css"; // plasmic-import: SzSP4r-gx0KC/css

import IconIcon from "./icons/PlasmicIcon__Icon"; // plasmic-import: Vq9OSV3gMyJR/icon
import Icon2Icon from "./icons/PlasmicIcon__Icon2"; // plasmic-import: kzHGh_wG3eLB/icon
...
function PlasmicPageLayout__RenderFunc(props: {
  ...
  return (
    <RichLayout
      ...
      logoElement={
        <Icon2Icon
          className={classNames(projectcss.all, sty.svg___17Wg0)}
          role={"img"}
        />
      }
      navMenuItems={(() => {
    ...
    >
      <LoadingBoundary
        ...
        loadingState={
          <DataCtxReader__>
            {$ctx => (
              <div className={classNames(projectcss.all, sty.freeBox__uuiEz)}>
                <IconIcon
                  className={classNames(projectcss.all, sty.svg__tz1G)}
                  role={"img"}
                />
              </div>
            )}
      ...
      >
        <DataCtxReader__>
          {$ctx => (
            <div className={classNames(projectcss.all, sty.freeBox__b2Cgk)}>
              {renderPlasmicSlot({
                defaultContents: (
                  <section
                    className={classNames(projectcss.all, sty.section___0TclA)}
                  >
                    <h1
                      className={classNames(
                        projectcss.all,
